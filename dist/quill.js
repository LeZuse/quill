...
},{"./op":8,"deep-equal":2,"fast-diff":6}],8:[function(_dereq_,module,exports){
var lib = {
  attributes: {
...
},{"../lib/dom":19,"../lib/linked-list":20,"./format":12,"./line":14,"./normalizer":15,"lodash":1,"rich-text/lib/delta":7}],11:[function(_dereq_,module,exports){
...
},{"../lib/dom":19,"./document":10,"./line":14,"./selection":16,"lodash":1,"rich-text/lib/delta":7}],12:[function(_dereq_,module,exports){
var Format, _, dom;
...
},{"../lib/dom":19,"../lib/linked-list":20,"./format":12,"./leaf":13,"./line":14,"./normalizer":15,"lodash":1,"rich-text/lib/delta":7}],15:[function(_dereq_,module,exports){
...
Wrapper = (function() {
  ...
  Wrapper.prototype.nextLineNode = function(root) {
    ...
    if ((nextNode == null) && this.node.parentNode !== root) {
      ...
      while (!(next.nextSibling || next.parentNode === root)) {
...
},{"../quill":32,"eventemitter2":5}],28:[function(_dereq_,module,exports){
...
},{"../package.json":9,"./core/document":10,"./core/editor":11,"./core/format":12,"./core/normalizer":15,"./lib/dom":19,"./lib/range":22,"./themes/base":34,"./themes/snow":35,"eventemitter2":5,"lodash":1,"rich-text/lib/delta":7}],33:[function(_dereq_,module,exports){
